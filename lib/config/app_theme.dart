...
class AppTheme {
  ...
  static const Color secondaryColor = Color(0xFFE2001D);
  static const Color secondaryLightColor = Color(0xFFF77373);
  static const Color secondaryDarkColor = Color(0xFFC92A2A);
